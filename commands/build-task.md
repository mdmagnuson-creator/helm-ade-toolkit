...
2. Use `helm_task_get` to read its full details, paying special attention to:
...
5. When complete, use `helm_task_update` to transition the task back to "ready_for_test" status
